package com.hyun.blog.integration;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.hyun.blog.application.UserPostRequestDTO;
...
public class UserIntegrationTest {
    ...
    void when_post_user_expect_return_created_user_with_token() throws Exception {
        UserPostRequestDTO userPostRequestDTO = new UserPostRequestDTO("username", "email", "password");
