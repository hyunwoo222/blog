...
class UserRestControllerTest {
    ...
    @Test
    void when_post_login_expect_userService_findFirstByEmailAndPassword_called() throws Exception {
        ...
        when(userService.login(loginDTO.getEmail(), loginDTO.getPassword()))
                .thenReturn(of(User.createNewUser("",loginDTO.getEmail(),loginDTO.getPassword())));
    ...
    void when_post_login_expect_valid_response_body() throws Exception {
        when(userService.login(anyString(),anyString()))
                .thenReturn(of(User.createNewUser("username","email","password")));
    ...
    void when_post_users_expect_valid_response() throws Exception {
        when(userService.createUser(any(User.class)))
                .thenReturn(User.createNewUser("username","email","password"));
